...
> **Para IA:** leia [docs/AI_CONTEXT.md](docs/AI_CONTEXT.md) antes de alterar este projeto.

> **Status:** em construção — será alinhado à lib-pixelbuild refatorada e ao novo endpoint público da API. O fluxo atual que usa `/structure` é legado.
